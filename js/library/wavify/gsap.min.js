...
!(function(t, e) {
            ...
            function(t, e, r) {
                ...
                if (!_) {
                    if (!(f = "auto" === c.grid ? 0 : (c.grid || [1, Y])[1])) {
                        for (
                            h = -Y; h < (h = r[f++].getBoundingClientRect().left) && f < d;
                        ...
                        if (
                            ...
                            if (
                                (s < d && (T = !T),
                                    ...
                                    (this._tTime = v), !e && this.parent && Ot(this, "onRepeat"),
                    ...
                    if (
                        (this._hasPause &&
                            ...
                            ((this._onUpdate = this.vars.onUpdate),
                                (this._initted = 1),
                                (this._zTime = t),
                                (c = 0)), !c && i && !e && (Ot(this, "onStart"), this._tTime !== v))
                    )
                        return this;
                    if (c <= i && 0 <= t)
                        for (n = this._first; n;) {
        ...
        if (
            ...
            (u = new ft[t]()).init(
                ...
                (function _processVars(t, e, r, i, n) {
                    if (
                        (p(t) && (t = Qt(t, n, e, r, i)), !s(t) || (t.style && t.nodeType) || J(t) || H(t))
                    )
        ...
        Xt = function _initTween(e, r) {
            ...
            if (
                (!F || (M && v) || (v = "none"),
                    ...
                    (e._from = !F && !!g.runBackwards), !F || (M && !g.stagger))
            ) {
                if (
                ...
                for (
                    e._pt = e._ptCache = 0, b = (A && t(b)) || (b && !A), n = 0; n < S.length; n++
                ) {
                    if (
            ...
            if (
                ...
                if (
                    ...
                    for (u = 0; u < l; u++)
                        ...
                        (h.delay =
                            (+Qt(g, _assertThisInitialized(a), u, d, C) || 0) - a._delay), !T &&
                        1 === l &&
                        h.delay &&
                ...
                if (p) {
                    if (
                        ...
                        if (((i = c), (l = this.timeline), this._repeat)) {
                            ...
                            a !== o &&
                                (l && this._yEase && Ib(l, u), !this.vars.repeatRefresh ||
                                    u ||
                                    this._lock ||
                                    ((this._lock = r = 1),
                        ...
                        this._onUpdate &&
                            ...
                            (t < 0 &&
                                ...
                                (t < 0 && !d) ||
                                (!c && !d) ||
                                (Ot(this, c === _ ? "onComplete" : "onReverseComplete", !0), !this._prom ||
            ...
            (e.resetTo = function resetTo(t, e, r, i) {
                ...
                return (
                    ...
                    (function _updatePropTweens(t, e, r, i, n, a, s) {
                        ...
                        if (!l)
                            for (
                                l = t._ptCache[e] = [], u = t._ptLookup, h = t._targets.length; h--;
    ...
    function zd(e) {
        ...
        return (
            (r && (r.width || r.height)) || e.getBBox === xd || (r = xd.call(e, !0)), !r || r.width || r.x || r.y ?
            r :
            {
                x: +yd(e, ["x", "cx", "x1"]) || 0,
                y: +yd(e, ["y", "cy", "y1"]) || 0,
    ...
    var le,
        ...
        je = function _checkPropPrefix(t, e, r) {
            ...
            for (
                t = t.charAt(0).toUpperCase() + t.substr(1); n-- && !(Qe[n] + t in i);
